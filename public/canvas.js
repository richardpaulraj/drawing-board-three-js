...
undo.addEventListener('click', () => {
  //undo meand going back
  if (track > 0) {
    //because there should be atleast one element so greater than 0
    track--
  }
...
function undoRedoCanvas(trackObj) {
  ...
  img.onload = (e) => {
    //you can even write it this way instead of addEventListner
...
pencilWidthElem.addEventListener('change', () => {
  //carefull we are using pencilWidthElem and not pencilWidth variable
